...
This file is the Phase 1 cross generator record. The Phase 2 headline numbers, the six suite battery, the five surprise seeds and the robustness measurements, live in the repository README's current status and Phase 2 results sections, each figure backed by its dated folder under `experiments/`.
