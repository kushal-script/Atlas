...
| Is the reference present? | always present | **about 20 percent of pairs contain no true instance** |
...
* Credit on the degraded set falls sharply with severity, to 0.206 at the hardest of four levels, where the failures are misses of hundreds of pixels rather than imprecision. They are not explained by blur bank coverage, prescreen budget or the presence threshold, each of which was measured and ruled out; the residual cause is information limited ambiguity under heavy degradation and it is the largest single gap in the method.
