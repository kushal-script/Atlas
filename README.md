...
The optical bonus set is scored separately, since it gates on a localization credit of 0.40 with the grayscale sets at 0.50. Two independently generated RGB brightfield suites under disjoint master seeds return credit 0.43 and 0.59, both clear of the gate, against a weighted grayscale credit of 0.72. The spread between the two optical suites is the sampling variance of small sets rather than a difference in method, and the lower of the two is the number to plan against.
