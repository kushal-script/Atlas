...
| Runtime | median 4.02 s per pair and 6.35 s worst case, measured through the entry point on a proportional holdout under the reference machine stack, Python 3.11 with numpy 2.4.6 and scipy 1.17.1 |
